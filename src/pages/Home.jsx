  ...
  return (
    <div className="flex flex-col container place-content-center justify-center items-center gap-20 mx-auto min-h-screen py-16 md:py-10">
      ...
      <div className="flex">
        ...
        />
        <div className="h-min flex flex-col gap-12 justify-center items-center z-10 bg-white p-10 rounded-xl shadow-2xl backdrop-filter backdrop-blur-xl bg-opacity-70">
          {renderCharacter()}
